...
<!DOCTYPE html>
<c:set var="angularVersion" value="1.6.1" scope="application" />
<c:set var="angularMaterialVersion" value="1.1.3" scope="application" />
<c:set var="swaggerUiVersion" value="2.2.10-1" scope="application" />
<html>
    <head>
